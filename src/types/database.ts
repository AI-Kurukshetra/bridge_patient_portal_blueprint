export type Database = {
  public: {
    Tables: {
      ...
      providers: { Row: { id: string; first_name: string; last_name: string; specialty: string; sub_specialty: string | null; organization: string | null; department: string | null; phone: string | null; email: string | null; city: string | null; state: string | null; accepting_patients: boolean; bio: string | null; languages: string[] | null } };
      appointments: { Row: { id: string; appointment_type: string; status: string; scheduled_at: string; duration_minutes: number; reason: string; notes: string | null; location: string | null; meeting_url: string | null; provider_id: string; patient_id: string } };

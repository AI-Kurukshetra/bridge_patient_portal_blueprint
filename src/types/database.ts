export type Database = {
  public: {
    Tables: {
      ...
      providers: { Row: { id: string; profile_id: string | null; first_name: string; last_name: string; specialty: string; sub_specialty: string | null; organization: string | null; department: string | null; phone: string | null; email: string | null; city: string | null; state: string | null; accepting_patients: boolean; bio: string | null; languages: string[] | null; created_at: string } };
      ...
      insurance_claims: { Row: { id: string; patient_id: string; provider_id: string | null; claim_number: string; payer_name: string; plan_name: string | null; claim_type: string; status: string; service_description: string; service_start: string | null; service_end: string | null; billed_amount_cents: number; allowed_amount_cents: number | null; covered_amount_cents: number | null; patient_responsibility_cents: number | null; submitted_at: string; processed_at: string | null; reference_number: string | null; denial_reason: string | null; notes: string | null; created_at: string; updated_at: string } };

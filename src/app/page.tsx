...
const highlights = [
  ...
  { title: "FHIR-ready data surface", body: "Current patient resources are exposed through typed route handlers for Patient, Condition, Observation, and AllergyIntolerance.", icon: FlaskConical },
];
    ...
    <main className="mx-auto flex min-h-screen max-w-7xl flex-col px-6 py-10">
      ...
      <section className="grid flex-1 items-center gap-10 py-16 lg:grid-cols-[1.15fr_0.85fr]">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">This build includes responsive auth screens, a protected portal shell, scheduling, secure messaging, lab visualization, prescription refill requests, billing, documents, notifications, consents, and typed server actions with client and server validation.</p>
        ...
        <div className="rounded-[2rem] border border-white/10 bg-slate-950/75 p-6 shadow-[0_40px_120px_-55px_rgba(34,211,238,0.7)] backdrop-blur">
          <div className="rounded-[1.5rem] border border-white/10 bg-white/5 p-6">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl bg-white/5 p-4"><p className="text-sm text-slate-300">FHIR endpoints</p><p className="mt-2 text-xl text-white">/api/fhir/*</p><p className="mt-1 text-sm text-slate-300">Patient, Condition, Observation, AllergyIntolerance</p></div>
            </div>
          </div>
        </div>
      </section>
